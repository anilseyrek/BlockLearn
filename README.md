...
- [ ] Add an email address to the `ADMINS` settings variable in `BlockLearn/BlockLearn/settings/base.py`
- [ ] Change the `SERVER_EMAIL` to the email address used to send e-mails in `BlockLearn/BlockLearn/settings/production.py`
